...
# Data sources to fetch AWS SSM parameters (GitHub token and username)
...
# Define the helm release module for install argocd
module "argocd" {
...
# Define the helm release module for install image updater 
module "updater" {
  source  = "terraform-module/release/helm"
  version = "2.8.1"
  app = {
...
# Define the helm release module for install application
module "app" {
  source  = "terraform-module/release/helm"
  version = "2.8.1"
  app = {
